...
const AlertsModal = ({ isVisible, onClose, devices }) => {
    ...
    const fetchAlertsData = async () => {
        try {
            ...
            const triggeredAlerts = alerts.filter((alert) => alert.triggered_at !== null).map((alert) => ({
                id: alert.id,
            ...
            const unTriggeredAlerts = alerts.filter((alert) => alert.triggered_at === null).map((alert) => ({
                id: alert.id,
                deviceId: alert.device_id,
                upperLimit: alert.upper_limit,
                lowerLimit: alert.lower_limit,
                ...
                <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                    <div>
                        <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <h2 className="text-2xl font-bold mt-8 mb-4">Untriggered Alerts</h2>
